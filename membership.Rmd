...
membership_annual =
  membership_df %>%
  filter(measure == "ct_annual_members") 
...
single_days_trips =
  membership_df %>%
  filter(measure %in% c("ct_single_day_passes","ct_single_trip_passes"))
...
end_of_month_annual_members =
  membership_df %>%
  filter(measure == "ct_total_annual_members")
