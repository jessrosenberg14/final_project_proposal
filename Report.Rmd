...
Notes/ questions: 
- tone from winning projects last year
- confirm MTA data source
- confirm with Zoe % change is 3/1/2020 to EOY 2020
- WHY WONT INLINE R CODE WORK (Variables count)
- Hide and show code chunks
- Which plots do we want to include? 
- Delete prompts
- Decide which exploratory things we want to include
...
3.    **Commuting Services**: How did CitiBike ridership change, if at all, due to COVID-19? Is the change mirrored in MTA data or does a change in CitiBike ridership compensate for a change in MTA ridership?
