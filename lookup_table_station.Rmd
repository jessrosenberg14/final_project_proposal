...
```{r, read in CSV files and create df with all unique stations}
...
```{r, update nyc_stations with address}
nyc_stations <-
...
```{r, write CSV file for all unique stations}
write_csv(nyc_stations, "nyc_stations.csv")
```

```{r, get only manhattan stations}
manhattan_stations <-
  nyc_stations %>%
