...
* We will be performing descriptive analyses: # of new stations, # of new users, ages of users, sex of users, # of riders (MTA)

* What amount of reduction in MTA ridership is compensated by increase in Citi Bike ridership
...
* How to create our intended visualizations (especially how to figure out how to show trends over time as we haven't learned this in class)
